...
const Layout = ({ hasNavbar, children, hasFooter }) => {
    return (
        <Box overflow="hidden" background="linear-gradient(180deg, #010431 57.09%, #5C1FAA 100%)" position="relative" bgColor="#DADADA" minH="100vh" minW="100%">
            ...
            <Image minH="1200px" minW="1450px" top={{base:"650px", md:"700px", lg:"800px"}} opacity={0.8} left={{base:"-100%", md:"-30%", lg:"0"}} position="absolute" src="/images/our_events/bg-ourevents.svg" alt="wavy bg" />
            <Image w="full" position="absolute" src="/title.png" alt="wavy bg" />
