...
const Merch = () => {
    return (
        <Box px={{ base: "12px", md: "auto" }} mt={{ base: "110px", md: "171px", lg: "232px" }} position="relative" borderRadius="8px" backgroundSize="cover" boxShadow="0px 4px 4px rgba(0, 0, 0, 0.25)" pb={{ base: "30px", md: "70px" }} pt="90px" className="primaryFont" backgroundImage="url(./merch-bg.png)" backgroundRepeat="no-repeat" backgroundPosition="center">
