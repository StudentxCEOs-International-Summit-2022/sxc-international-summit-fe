        ...
        >
          ...
          <Box maxWidth={{ base: "100%", md: "100%", lg: "85%" }}>
            <Text
              ...
              pb="24px"
            >
              Student Ambassador Referral Code
            </Text>
          </Box>
          <Text
            className="primaryFont"
            ...
            mx={{ base: "14px", md: "0px" }}
          >
            {"Get to know our Student Ambassadors and obtain an exclusive referral code from their social media. This referral code can be used to get a discount for our Business Case Competition."}
          </Text>
        </Flex>
        <Flex flexDirection={{ base: "column", lg: "row" }}>
          <NextLink href="#student-ambassadors" passHref>
            <Link>
              <Button
                w={{ base: "100%", md: "auto" }}
                className="primaryFont"
