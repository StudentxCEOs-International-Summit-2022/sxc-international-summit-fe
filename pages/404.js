...
export default function FourOhFour() {
    return <Layout hasNavbar hasFooter>
        ...
        <Flex justify="center" flexDirection="column" align="center" w="100%" minH="100vh">
            <Image opacity={0.3} left="-20%" top="-5%" position="absolute" w="1300px" h="1400px" src="/bg-partners.png" alt="wavy bg" />
            <Text
                fontWeight={800}
                fontSize="150px"
                lineHeight={1.2}
