...
const RegisterPage = () => {
    ...
    const onSubmit = data => {
        ...
        localStorage.setItem("registrationData", JSON?.stringify(data))
        axios.post("https://sxc-be-22.herokuapp.com/api/daftarChambers", data).then(res => {
            console.log(res);
            // emailjs.sendForm('service_tsfahql', 'template_jhrmk2n', form.current, 'v3UAkQDIaD4CYo73r')
            //     .then((result) => {
                            ...
                            >
                                ...
                                <form ref={form} onSubmit={(e) => {
                                    ...
                                    <FormControl className="primaryFont" key="registerForm" maxW="720px" mx="auto">
                                        ...
                                        <Select id="chamber" {...register("chamber", { required: true })}>
                                            <option style={{ backgroundColor: "#020234" }} value="fmcg">FMCG</option>
                                            <option style={{ backgroundColor: "#020234" }} value="consulting">Consulting</option>
                                            <option style={{ backgroundColor: "#020234" }} value="startup">Startup</option>
                                            <option style={{ backgroundColor: "#020234" }} value="bumn">BUMN</option>
                                        </Select>
                                ...
                                <Box
                                    ...
                                    <Box mb="50px" mx="64px">
                                        ...
                                        <Text
                                            ...
                                            lineHeight={1.5}
                                        >
                                            {`Career path choosed`}<br />{savedData?.["chamber"]}
                                        </Text>
                            ...
                            <Box
                                ...
                                <Box mb="50px" p="24px" mx="64px" textAlign="center">
                                    <Text fontWeight={800}
                                        fontSize="32px"
                                        lineHeight={1.2}
                                        className="primaryFont">Are you sure you want to submit?</Text>
                                    ...
                                    <form ref={form} onSubmit={handleSubmit(onSubmit)} id="registerFormHidden">
                                        <FormControl display="none" className="primaryFont" key="registerForm" maxW="720px" mx="auto">
                                            ...
                                            <Select id="chamber" value={savedData?.["chamber"]}
                                        ...
                                        <Center>
                                            <Button
                                                ...
                                                mb="24px" onClick={() => setCurrentStep(currentStep - 1)}
                                                mt="42px"
                                                borderRadius="4px"
                                                borderColor="#5D11AB"
                                                p="10px 24px"
